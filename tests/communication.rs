...
mod tests {
    ...
    async fn multiple_structures() {
        ...
        let client_handle = tokio::task::spawn_blocking(|| {
            let mut map1: SMap<String, i32> = SMap::new(7878, 1, "First".into());
            let map2: SMap<String, i32> = SMap::new(7878, 1, "Second".into());
            let mut map3: SMap<String, i32> = SMap::new(7878, 2, "Third".into());
            let map4: SMap<String, i32> = SMap::new(7878, 2, "Fourth".into());
